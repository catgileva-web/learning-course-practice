...
With the introduction of the ChartDataProvider in v8, the chart data can be accessed from any component. This lets you create HTML components that interact with the charts data.
